  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:from-primary/90 hover:to-accent/90 shadow-glow hover:shadow-strong hover:scale-105",
        smart: "bg-gradient-to-br from-accent to-accent-light text-accent-foreground hover:from-accent/90 hover:to-accent-light/90 shadow-soft hover:shadow-glow hover:-translate-y-1",
        tech: "border border-primary/20 bg-primary/5 text-primary hover:bg-primary/10 hover:border-primary/30 backdrop-blur-sm",
      },
      size: {
